...
const MovieSlider = ({ title, movies, subtitle = "" }) => {
  ...
  const [hoveredMoviesId, setIsHoveredMoviesId] = useState(null);
                ...
                >
                  <div className="rounded-lg overflow-hidden bg-neutral-800">
                    <div className="relative aspect-2/3">
                      ...
                      />
                      <div
                        className={`absolute inset-0 bg-linear-to-t from-neutral-900/90 via-neutral-900/40 
