                ...
                >
                  <div className="relative rounded-lg overflow-hidden bg-neutral-800">
                    ...
                    duration-300 group-hover:scale-110 group-hover:opacity-35"
                      />
                      <div
                        className="absolute inset-0 bg-lienar-to-t from-neutral-900/90 
                via-neutral-900/40 to-transparent opacity-0 group-hover:opacity-100 
                transition-all duration-300 flex flex-col justify-end p-4 gap-3"
                      >
                  ...
                  py-3 rounded-md flex items-center justify-center gap-2 transition-all text-sm"
                        >
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            className="h-4 w-4"
                  ...
                  <div className="mt-3">
                    <h3 className="text-white text-sm italic font-bold truncate">
                      {movie.title}
                    </h3>
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-1">
