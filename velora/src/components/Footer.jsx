        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <p className="mb-4 text-sm italic font-sans">
              ...
              Velora gives you access to a vast collection of films across all
              genres.
            </p>
